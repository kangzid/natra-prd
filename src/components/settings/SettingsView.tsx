...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-[1400px] mx-auto px-4 sm:px-8 py-6">
      ...
      {/* Section: Onboarding & Guided Tour */}
      {(onOpenOnboarding || onStartTour) && (
        <div className="bg-white dark:bg-[#111827] rounded-2xl border border-slate-200/80 dark:border-[#1e293b] p-5 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-start space-x-3.5">
            {/* Circle container with blue icon */}
            <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-950/60 ring-1 ring-blue-200 dark:ring-blue-800/60 flex items-center justify-center text-blue-600 dark:text-blue-400 shrink-0">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Replay the product walkthrough or interactive menu tour anytime.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            {onStartTour && (
              <button
                type="button"
                onClick={onStartTour}
                className="inline-flex items-center space-x-2 px-4 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-full shadow-2xs transition-colors shrink-0"
              >
                <div className="w-4 h-4 rounded-full bg-blue-50 dark:bg-blue-950/60 ring-1 ring-blue-200 dark:ring-blue-800/50 flex items-center justify-center text-blue-600 dark:text-blue-400">
                  <Compass className="w-2.5 h-2.5 text-blue-600 dark:text-blue-400" />
                </div>
            ...
            {onOpenOnboarding && (
              <button
                ...
                className="inline-flex items-center space-x-2 px-4 py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-full shadow-2xs transition-colors shrink-0"
              >
      ...
      <div className="bg-white dark:bg-[#111827] rounded-2xl border border-slate-200/80 dark:border-[#1e293b] p-5 shadow-2xs space-y-2">
        ...
        <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
          API keys are encrypted locally in your browser IndexedDB and sent directly to Google AI endpoints with zero proxy servers.
        </p>
      </div>
